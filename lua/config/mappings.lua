...
vim.keymap.set({"n", "t"}, "<A-H>", function() require("smart-splits").resize_left() end, {desc="Resize to left"})
vim.keymap.set({"n", "t"}, "<A-L>", function() require("smart-splits").resize_right() end, {desc="Resize to right"})
vim.keymap.set({"n", "t"}, "<A-J>", function() require("smart-splits").resize_down() end, {desc="Resize bottom"})
vim.keymap.set({"n", "t"}, "<A-K>", function() require("smart-splits").resize_up() end, {desc="Resize up"})

vim.keymap.set({"n", "t"}, "<A-h>", function() require("smart-splits").move_cursor_left() end, {desc="Goto left window/tmux pane"})
vim.keymap.set({"n", "t"}, "<A-l>", function() require("smart-splits").move_cursor_right() end, {desc="Goto right window/tmux pane"})
vim.keymap.set({"n", "t"}, "<A-j>", function() require("smart-splits").move_cursor_down() end, {desc="Goto bottom window/tmux pane"})
vim.keymap.set({"n", "t"}, "<A-k>", function() require("smart-splits").move_cursor_up() end, {desc="Goto top window/tmux pane"})
vim.keymap.set({"n", "t"}, "<A-\\>", function() require("smart-splits").move_cursor_previous() end, {desc="Goto previous window/tmux pane"})
